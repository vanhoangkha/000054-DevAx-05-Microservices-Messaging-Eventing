...
#### Nội dung:
1. [Các bước chuẩn bị](4.1-prequistite/)
2. [Gửi các Bản ghi](4.2-send-records/)
3. [Kiểm tra trong ElasticSearch](4.3-verify-elasticsearch/)
4. [Khám phá Kibana](4.4-kibana/)
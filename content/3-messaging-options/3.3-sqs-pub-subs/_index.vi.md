...
pre = "<b>3.3. </b>"
+++
#### SQS Publisher tới nhiều SQS Subscriber 
...
Bất kể khung subscriber nào nhận được thông tin điểm vẽ, tất cả các thông tin đã gửi sẽ được nhận - bạn có thể xác nhận điều này bằng cách so sánh bộ đếm **messages Sent** với bộ đếm **messages Received** trong bảng thống kê của publisher - chúng cuối cùng sẽ bằng nhau.

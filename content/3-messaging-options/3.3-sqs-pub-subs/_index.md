...
pre = "<b>3.3. </b>"
+++
#### SQS Publisher to Multiple SQS Subscribers
...
![SQS Publisher To Multiple SQS Subscribers](/images/3-messaging-options/3.3-sqs-pub-subs/sqspubmultisub-architecture.png?featherlight=false&width=70pc)
...
* When the page initialisation completes, draw a shape in the publisher canvas on the left, and observe the behaviour of the three subscriber canvases on the right. As you draw, messages will be sent to an SQS queue containing information about the X & Y coordinates of the mouse. These messages will be received by the browser polling the same SQS queue with 3 different subscribers, each rendering the events they receive on their own canvas.
![SQS Publisher To Multiple SQS Subscribers](/images/3-messaging-options/3.3-sqs-pub-subs/sqs-pub-subs-001.png?featherlight=false&width=90pc)
